...
html_head="<!DOCTYPE html>
  <html>
    <head>
      ...
      <link rel="alternate" type="application/rss+xml" title="RSS" href="./web_deploy/feed.xml">
      <script>
        var _hmt = _hmt || [];
        (function() {
        ...
        <td valign="top" width="20%">
          <table id="sidebar" style='margin-top: 20px;margin-bottom: 20px;'>
            <tbody>
              ...
              <tr><td><img src="./web_deploy/rss.png" alt="rss"><a href="./web_deploy/feed.xml"><b>RSS</b></a></td></tr>
              <tr><td>"
        ...
        then
            ...
            if [[ "$html" -ne 0 ]];then
                ...
                do
                    ...
                    <tr style='font-size: 15px;'><td><a href=\"./index.html#gitalk-container\" target=\"_parent\">原文链接失效了?给我留言</a></td></tr> \
...
TZ='Asia/Shanghai' node ./web_deploy/generate-rss.js
